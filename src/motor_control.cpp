...
const long pasosPorDisp = (long)(STEPS_PER_REVOLUTION * TOTAL_VUELTAS) / (TOTAL_DISPENSADORES - 1);

Stepper baseStepper(STEPS_PER_REVOLUTION, basePins[0], basePins[1], basePins[2], basePins[3]);
Stepper serveStepper(STEPS_PER_REVOLUTION, servePins[0], servePins[1], servePins[2], servePins[3]);
